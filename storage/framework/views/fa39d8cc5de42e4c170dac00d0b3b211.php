<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.manage_books')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.main')); ?>"><?php echo e(__('panel.main')); ?></a> \</li>
                    <li class="ms-1"><?php echo e(__('panel.show_books')); ?></li>
                </ul>
            </div>
            <div class="ml-auto">
                <?php if (\Entrust::ability('admin', 'create_books')) : ?>
        ...
        <?php echo $__env->make('backend.books.filter.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="checkfilter" value="<?php echo e($book->id); ?>">
                            </td>
                            <td><?php echo e($book->title); ?></td>
                            <td class="d-none d-sm-table-cell">
                                <?php echo e($book->creator?->first_name ?? __('panel.unknown')); ?>

                            </td>
                            <td class="d-none d-sm-table-cell text-center">
                                <a href="javascript:void(0);" class="updateBookStatus" id="book-<?php echo e($book->id); ?>"
                            ...
                            <td class="d-none d-sm-table-cell">
                                <?php echo e($book->published_on?->diffForHumans() ?? '-'); ?>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <div class="dropdown mb-2">
                                        <a class="d-flex align-items-center" href="#"
                                            id="dropdownMenuButton<?php echo e($book->id); ?>" data-bs-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($book->id); ?>">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="<?php echo e(route('admin.books.edit', $book->id)); ?>">
                                                <i data-feather="edit-2" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_edit')); ?></span>
                                            </a>
                                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                                onclick="confirmDelete('delete-book-<?php echo e($book->id); ?>', '<?php echo e(__('panel.confirm_delete_message')); ?>', '<?php echo e(__('panel.yes_delete')); ?>', '<?php echo e(__('panel.cancel')); ?>')">
                                                <i data-feather="trash" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_delete')); ?></span>
                                            </a>
                                            <form id="delete-book-<?php echo e($book->id); ?>"
                                                action="<?php echo e(route('admin.books.destroy', $book->id)); ?>" method="POST"
                                                class="d-none">
                                                <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.updateBookStatus', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('admin.books.toggleStatus')); ?>',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        if (isActive) {
                            ...
                            Swal.fire({
                                ...
                                position: 'top-end',
                                icon: 'success',
                                title: '<?php echo e(__('panel.status_changed_successfully')); ?>',
                    ...
                    error: function(xhr) {
                        ...
                        Swal.fire({
                            ...
                            text: '<?php echo e(__('panel.error_while_changing_status')); ?>',
                ...
                if (result.isConfirmed) {
                    ...
                    if (form) {
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire({
                                    title: '<?php echo e(__('panel.operation_success')); ?>',
                                    text: '<?php echo e(__('panel.item_deleted_successfully') ?? 'تم حذف العنصر بنجاح.'); ?>',
                                    icon: 'success',
                                    timer: 1200,
                                    showConfirmButton: false
                                });
                            ...
                            error: function() {
                                Swal.fire('<?php echo e(__('panel.something_was_wrong')); ?>',
                                    '<?php echo e(__('panel.error_on_delete') ?? 'حدث خطأ أثناء الحذف، حاول مجددًا.'); ?>',
                                    'error');
                            }
                        });
                    } else {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/books/index.blade.php ENDPATH**/ ?>