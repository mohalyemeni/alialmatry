        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.edit_blog_category')); ?>
    ...
    <script>
        $(function() {
            $("#img").fileinput({
                ...
                initialPreview: [
                    <?php if($category->img): ?>
                        "<?php echo e(asset('assets/blog_categories/' . $category->img)); ?>"
                    <?php endif; ?>
                ],
                    ...
                    <?php if($category->img): ?>
                        {
                            ...
                            url: "<?php echo e(route('admin.blog_categories.remove_image')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/blog_categories/edit.blade.php ENDPATH**/ ?>