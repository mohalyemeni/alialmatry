<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.manage_useful_links')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('panel.main')); ?></a> \</li>
                    <li class="ms-1"><?php echo e(__('panel.show_useful_links')); ?></li>
                </ul>
            </div>
            <div class="ml-auto">
                <?php if (\Entrust::ability('admin', 'create_useful_link')) : ?>
                    <a href="<?php echo e(route('admin.useful_links.create')); ?>" class="btn btn-primary">
        ...
        <?php echo $__env->make('backend.useful_links.filter.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="checkfilter" value="<?php echo e($link->id); ?>">
                            </td>
                            <td><?php echo e($link->title); ?></td>

                            <td class="d-none d-sm-table-cell">
                                <?php echo e($link->creator?->first_name ?? __('panel.unknown')); ?>

                            </td>
                            <td class="d-none d-sm-table-cell">
                                <a href="javascript:void(0);" class="updateUsefulLinkStatus"
                                    id="useful-link-<?php echo e($link->id); ?>" useful_link_id="<?php echo e($link->id); ?>">
                                    <?php if($link->status): ?>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <?php echo e($link->published_on?->diffForHumans() ?? '-'); ?>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <div class="dropdown mb-2">
                                        <a class="d-flex align-items-center" href="#"
                                            id="dropdownMenuButton<?php echo e($link->id); ?>" data-bs-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($link->id); ?>">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="<?php echo e(route('admin.useful_links.edit', $link->id)); ?>">
                                                <i data-feather="edit-2" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_edit')); ?></span>
                                            </a>
                                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                                onclick="confirmDelete('delete-useful-link-<?php echo e($link->id); ?>', '<?php echo e(__('panel.confirm_delete_message')); ?>', '<?php echo e(__('panel.yes_delete')); ?>', '<?php echo e(__('panel.cancel')); ?>')">
                                                <i data-feather="trash" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_delete')); ?></span>
                                            </a>
                                            <form id="delete-useful-link-<?php echo e($link->id); ?>"
                                                action="<?php echo e(route('admin.useful_links.destroy', $link->id)); ?>"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.updateUsefulLinkStatus', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('admin.useful_links.toggleStatus')); ?>',
                    data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/useful_links/index.blade.php ENDPATH**/ ?>