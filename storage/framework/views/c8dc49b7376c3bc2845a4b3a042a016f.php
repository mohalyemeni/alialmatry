<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.manage_video_categories')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('panel.main')); ?></a> \</li>
                    <li class="ms-1"><?php echo e(__('panel.show_video_categories')); ?></li>
                </ul>
            </div>

            <div class="ml-auto">
                <?php if (\Entrust::ability('admin', 'create_categories')) : ?>
                    <a href="<?php echo e(route('admin.video_categories.create')); ?>" class="btn btn-primary">
        ...
        <?php echo $__env->make('backend.video_categories.filter.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <a href="javascript:void(0);" class="updatePageCategoryStatus"
                                    id="page-category-<?php echo e($page_category->id); ?>"
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <a href="javascript:void(0);" class="toggleVideoCategoryFeatured"
                                    id="video-category-featured-<?php echo e($page_category->id); ?>"
                                    page_category_id="<?php echo e($page_category->id); ?>">
                                    ...
                                    <div class="dropdown mb-2">
                                        ...
                                        <div class="dropdown-menu"
                                            ...
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="<?php echo e(route('admin.video_categories.edit', $page_category->id)); ?>">
                                                <i data-feather="edit-2" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_edit')); ?></span>
                                            </a>

                                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                                onclick="confirmDelete('delete-video-category-<?php echo e($page_category->id); ?>', '<?php echo e(__('panel.confirm_delete_message')); ?>', '<?php echo e(__('panel.yes_delete')); ?>', '<?php echo e(__('panel.cancel')); ?>')">
                                                <i data-feather="trash" class="icon-sm me-2"></i>
                                                <span><?php echo e(__('panel.operation_delete')); ?></span>
                                            </a>

                                            <form id="delete-video-category-<?php echo e($page_category->id); ?>"
                                                action="<?php echo e(route('admin.video_categories.destroy', $page_category->id)); ?>"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.updatePageCategoryStatus', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('admin.video_categories.toggleStatus')); ?>',
                    data: {
            ...
            $(document).on('click', '.toggleVideoCategoryFeatured', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('admin.video_categories.toggleFeatured')); ?>',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        category_id: category_id
                    },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/video_categories/index.blade.php ENDPATH**/ ?>