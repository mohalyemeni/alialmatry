                    ...
                    <div class="col-9 col-md-10 col-lg-3">
                        <div class="header-logo">
                            <a href="<?php echo e(route('frontend.index')); ?>" class="logo_img">
                                <img src="<?php echo e(asset('frontand/assets/img/top-logo.png')); ?>" alt="توبة">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 col-xl-10">
                                <nav class="main-menu d-none d-lg-inline-block ml-10">
                                    <ul>
                                        ...
                                        <li><a href="<?php echo e(route('frontend.videos.index')); ?>" class="ajax-link">
                                                المرئيات</a></li>
                                        ...
                                        <li><a href="<?php echo e(route('frontend.blogs.index')); ?>" class="ajax-link">
                                                المقالات</a></li>
