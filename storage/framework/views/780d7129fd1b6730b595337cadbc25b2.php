<div class="card-body">
    <form action="<?php echo e(route('admin.main_sliders.index')); ?>" method="get">
        <div class="row">
            <!-- كلمة البحث -->
...
<?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/main_sliders/filter/filter.blade.php ENDPATH**/ ?>