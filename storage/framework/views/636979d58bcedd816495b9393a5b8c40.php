<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.fatawa.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                <small class="text-muted"><?php echo e(__('panel.optional_audio_file')); ?></small>
                            </div>
                        </div>
                        <!-- تاريخ النشر -->
                        <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/fatawa/create.blade.php ENDPATH**/ ?>