        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    <i class="fas fa-user-tie"></i> <?php echo e(__('panel.edit_sheikh_intro')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('panel.main')); ?></a> /</li>
                    <li class="ms-1"><a
                            href="<?php echo e(route('admin.sheikh_intro.index')); ?>"><?php echo e(__('panel.manage_sheikh_intro')); ?></a> /</li>
                    <li class="ms-1"><a href=""><?php echo e($intro->title); ?></a></li>
                </ul>
            </div>
        </div>
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.sheikh_intro.update', $intro->id)); ?>" method="POST"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <input type="text" name="title" id="title"
                                    value="<?php echo e(old('title', $intro->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo old('description', $intro->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            <label for="img"
                                class="col-sm-12 col-md-2 pt-3"><?php echo e(__('panel.change_image')); ?><br><small><?php echo e(__('panel.best_size')); ?></small></label>
                            <div class="col-sm-12 col-md-10 pt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <div class="input-group flatpickr" id="flatpickr-datetime">
                                    <input type="text" name="published_on"
                                        value="<?php echo e(old('published_on', $intro->published_on?->format('Y-m-d H:i'))); ?>"
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_active"
                                        value="1" <?php echo e(old('status', $intro->status) == '1' ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_inactive"
                                        value="0" <?php echo e(old('status', $intro->status) == '0' ? 'checked' : ''); ?>>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input type="text" name="meta_slug" id="meta_slug"
                                    value="<?php echo e(old('meta_slug', $intro->meta_slug)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <textarea name="meta_description" id="meta_description" rows="3" class="form-control"><?php echo e(old('meta_description', $intro->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-12 col-md-10 pt-3">
                        ...
                        <a href="<?php echo e(route('admin.sheikh_intro.index')); ?>" class="btn btn-outline-danger">
    ...
    <script>
        $(function() {
            $("#img").fileinput({
                ...
                maxFileCount: 1,
                <?php if($intro->img): ?>
                    initialPreview: ["<?php echo e(asset('assets/sheikh_intro/images/' . $intro->img)); ?>"],
                    initialPreviewAsData: true,
                    initialPreviewFileType: 'image',
                    initialPreviewConfig: [{
                        caption: "<?php echo e(basename($intro->img)); ?>",
                        url: "<?php echo e(route('admin.sheikh_intro.remove_image')); ?>",
                        key: "<?php echo e($intro->id); ?>",
                        extra: {
                            _token: "<?php echo e(csrf_token()); ?>",
                            id: "<?php echo e($intro->id); ?>"
                        }
                    }],
                <?php endif; ?>
                fileActionSettings: {
            ...
            if ($('#flatpickr-datetime').length) {
                const defaultDate = "<?php echo e(old('published_on', $intro->published_on?->format('Y-m-d H:i'))); ?>" ||
                    new Date();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/sheikh_intro/edit.blade.php ENDPATH**/ ?>