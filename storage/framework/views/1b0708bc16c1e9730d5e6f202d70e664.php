<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.settings.site_socials.edit', 3)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_facebook" id="site_facebook" class="form-control"
                            value="<?php echo e($site_facebook->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_twitter" id="site_twitter" class="form-control"
                            value="<?php echo e($site_twitter->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_whatsapp" id="site_whatsapp" class="form-control"
                            value="<?php echo e($site_whatsapp->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_linkedin" id="site_linkedin" class="form-control"
                            value="<?php echo e($site_linkedin->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_instagram" id="site_instagram" class="form-control"
                            value="<?php echo e($site_instagram->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_snapchat" id="site_snapchat" class="form-control"
                            value="<?php echo e($site_snapchat->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_youtube" id="site_youtube" class="form-control"
                            value="<?php echo e($site_youtube->value ?? ''); ?>">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/site_socials/index.blade.php ENDPATH**/ ?>