        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.add_sheikh_page')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('panel.main')); ?></a> /</li>
                    <li class="ms-1"><a
                            href="<?php echo e(route('admin.sheikh_pages.index')); ?>"><?php echo e(__('panel.manage_sheikh_pages')); ?></a></li>
                </ul>
            </div>
        </div>
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.sheikh_pages.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-12 col-md-10 pt-3">
                        ...
                        <a href="<?php echo e(route('admin.sheikh_pages.index')); ?>" class="btn btn-outline-danger">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/sheikh_pages/create.blade.php ENDPATH**/ ?>