        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    <i class="fa fa-edit"></i> <?php echo e(__('panel.edit_fatwa')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index_route')); ?>"><?php echo e(__('panel.home')); ?></a> /</li>
                    <li class="ms-1"><a href="<?php echo e(route('admin.fatawa.index')); ?>"><?php echo e(__('panel.manage_fatawa')); ?></a> /</li>
                    <li class="ms-1"> <a href=""> <?php echo e($fatwa->title); ?></a></li>
                </ul>
            </div>
        </div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.fatawa.update', $fatwa->id)); ?>" method="POST" enctype="multipart/form-data"
                novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>"
                                            <?php echo e(old('category_id', $fatwa->category_id) == $category->id ? 'selected' : ''); ?>>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <input type="text" name="title" id="title"
                                    value="<?php echo e(old('title', $fatwa->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo old('description', $fatwa->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <?php if($fatwa->audio_file): ?>
                                    <audio controls style="width: 100%; max-width: 400px;">
                                        <source src="<?php echo e(asset('assets/fatawa/files/' . $fatwa->audio_file)); ?>"
                                            type="audio/mpeg">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <input type="file" name="audio_file" id="audio_file" class="form-control"
                                    accept="audio/*">
                                <small class="text-muted"><?php echo e(__('panel.leave_empty_to_keep_current_audio')); ?></small>
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <div class="input-group flatpickr" id="flatpickr-datetime">
                                    <input type="text" name="published_on"
                                        value="<?php echo e(old('published_on', $fatwa->published_on?->format('Y-m-d H:i'))); ?>"
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_active"
                                        value="1" <?php echo e(old('status', $fatwa->status) == '1' ? 'checked' : ''); ?>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_inactive"
                                        value="0" <?php echo e(old('status', $fatwa->status) == '0' ? 'checked' : ''); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input type="text" name="meta_slug" id="meta_slug"
                                    value="<?php echo e(old('meta_slug', $fatwa->meta_slug)); ?>" class="form-control">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input name="meta_keywords" id="tags1"
                                    value="<?php echo e(old('meta_keywords', $fatwa->meta_keywords)); ?>" class="form-control" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <textarea name="meta_description" id="meta_description" rows="3" class="form-control"><?php echo e(old('meta_description', $fatwa->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-12 col-md-10 pt-3">
                        ...
                        <a href="<?php echo e(route('admin.fatawa.index')); ?>" class="btn btn-outline-danger">
    ...
    <script>
        $(function() {
            $("#img").fileinput({
                ...
                initialPreview: [
                    <?php if($fatwa->img): ?>
                        "<?php echo e(asset('assets/fatawa/images/' . $fatwa->img)); ?>"
                    <?php endif; ?>
                ],
                ...
                initialPreviewConfig: [
                    <?php if($fatwa->img): ?>
                        {
                            caption: "<?php echo e(basename($fatwa->img)); ?>",
                            url: "<?php echo e(route('admin.fatawa.remove_image')); ?>",
                            key: "<?php echo e($fatwa->id); ?>",
                            extra: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                id: "<?php echo e($fatwa->id); ?>"
                            }
                        }
                    <?php endif; ?>
                ],
            ...
            $("#audio_file").fileinput({
                ...
                initialPreview: [
                    <?php if($fatwa->img): ?>
                        "<?php echo e(asset('assets/fatawa/files/' . $fatwa->audio_file)); ?>"
                    <?php endif; ?>
                ],
                initialPreviewAsData: true,
                ...
                initialPreviewConfig: [
                    <?php if($fatwa->audio_file): ?>
                        {
                            caption: "<?php echo e(basename($fatwa->audio_file)); ?>",
                            url: "<?php echo e(route('admin.fatawa.remove_audio')); ?>",
                            key: "<?php echo e($fatwa->id); ?>",
                            extra: {
                                _token: "<?php echo e(csrf_token()); ?>",
                                id: "<?php echo e($fatwa->id); ?>"
            ...
            if ($('#flatpickr-datetime').length) {
                const defaultDate = "<?php echo e(old('published_on', $fatwa->published_on?->format('Y-m-d H:i'))); ?>" ||
                    new Date();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/fatawa/edit.blade.php ENDPATH**/ ?>