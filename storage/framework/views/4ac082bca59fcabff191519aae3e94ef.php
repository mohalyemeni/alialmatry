        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.manage_sheikh_pages')); ?>

                </h3>
                <ul class="breadcrumb pt-3">
                    <li><a href="<?php echo e(route('admin.index')); ?>"><?php echo e(__('panel.main')); ?></a> \</li>
                    <li class="ms-1"><?php echo e(__('panel.show_sheikh_pages')); ?></li>
                </ul>
            </div>
            <div class="ml-auto">
                <?php if (\Entrust::ability('admin', 'create_sheikh_page')) : ?>
                    <a href="<?php echo e(route('admin.sheikh_pages.create')); ?>" class="btn btn-primary">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="checkfilter" value="<?php echo e($page->id); ?>">
                            </td>
                            <td><?php echo e($page->title); ?></td>
                            <td class="d-none d-sm-table-cell">
                                <a href="javascript:void(0);" class="updatePageStatus" id="page-<?php echo e($page->id); ?>"
                            ...
                            <td class="d-none d-sm-table-cell">
                                <?php echo e($page->published_on?->diffForHumans() ?? '-'); ?>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <div class="dropdown mb-2">
                                        <a class="d-flex align-items-center" href="#"
                                            id="dropdownMenuButton<?php echo e($page->id); ?>" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
                                            <i data-feather="more-vertical" class="icon-sm text-muted"></i>
                                            <?php echo e(__('panel.operation_options')); ?>

                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($page->id); ?>">
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="<?php echo e(route('admin.sheikh_pages.edit', $page->id)); ?>">
                                            ...
                                            <form id="delete-page-<?php echo e($page->id); ?>"
                                                action="<?php echo e(route('admin.sheikh_pages.destroy', $page->id)); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.updatePageStatus', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('admin.sheikh_pages.toggleStatus')); ?>',
                    data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/sheikh_pages/index.blade.php ENDPATH**/ ?>