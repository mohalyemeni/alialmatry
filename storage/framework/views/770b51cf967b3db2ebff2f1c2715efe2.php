<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.audios.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/audio/create.blade.php ENDPATH**/ ?>