<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.edit_video_category')); ?>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.video_categories.update', $category->id)); ?>" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <input type="text" name="title" id="title"
                                    value="<?php echo e(old('title', $category->title)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <textarea name="description" id="description" rows="10" class="form-control summernote"><?php echo old('description', $category->description); ?></textarea>
                            ...
                            <div class="col-sm-12 col-md-10 pt-3 d-flex align-items-center gap-3">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_active"
                                        value="1"
                                        <?php echo e((string) old('status', $category->status) === '1' ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status" id="status_inactive"
                                        value="0"
                                        <?php echo e((string) old('status', $category->status) === '0' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 pt-3">
                                <label for="featured"><?php echo e(__('panel.featured') ?? 'مميز'); ?></label>
                            </div>
                            <div class="col-sm-12 col-md-10 pt-3">
                                
                                <input type="hidden" name="featured" id="featured_input"
                                    value="<?php echo e((int) old('featured', $category->featured) ? 1 : 0); ?>">
                                <button type="button" id="featured_btn" class="btn btn-light p-2"
                                    aria-pressed="<?php echo e((int) old('featured', $category->featured) ? 'true' : 'false'); ?>"
                                    title="<?php echo e(__('panel.toggle_featured') ?? 'تبديل المميز'); ?>">
                                    <i id="featured_icon"
                                        class="<?php echo e((int) old('featured', $category->featured) ? 'fas fa-star text-warning' : 'far fa-star text-muted'); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input type="text" name="meta_slug" id="meta_slug"
                                    value="<?php echo e(old('meta_slug', $category->meta_slug)); ?>" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input name="meta_keywords" id="meta_keywords"
                                    value="<?php echo e(old('meta_keywords', $category->meta_keywords)); ?>" class="form-control" />
    ...
    <script>
        $(function() {
            $("#img").fileinput({
                ...
                initialPreview: [
                    <?php if($category->img): ?>
                        "<?php echo e(asset('assets/video_categories/' . $category->img)); ?>"
                    <?php endif; ?>
                ],
                    ...
                    <?php if($category->img): ?>
                        {
                            ...
                            url: "<?php echo e(route('admin.video_categories.remove_image')); ?>",
    ...
    <script>
        $(function() {
            $('#featured_btn').on('click', function() {
                ...
                var val = $input.val();
                var is = (val === '1' || val === 1 || val === 'true' || val === true);
                if (is) {
                    $input.val('0');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/video_categories/edit.blade.php ENDPATH**/ ?>