                ...
                <div class="widget1 footer-widget1 mb-4 p-3">
                    ...
                    <?php if($recentList->isNotEmpty()): ?>
                        <div class="recent-post-wrap">
                            ...
                            <a class="text-inherit d-block" href="<?php echo e(route('frontend.audios.show', $item->slug)); ?>">
...
<?php else: ?>
    ...
    <div class="mt-3 text-end">
        <?php if($category->slug): ?>
            <a href="<?php echo e(route('frontend.audios.category', $category->slug)); ?>" class="th-btn">عرض المزيد <i
                        ...
                        <a href="<?php echo e(route('frontend.audios.category', $fc->slug)); ?>"
                            ...
                            <div style="flex:1; min-width:0;">
                                ...
                                <div class="text-muted small">
                                    <?php echo e($fc->audios_count ?? $fc->audios()->where('status', 1)->count()); ?> صوت
                                </div>
                            </div>
                        </a>
                    </li>
