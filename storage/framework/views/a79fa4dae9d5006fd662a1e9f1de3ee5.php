<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.add_useful_link')); ?>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.useful_links.store')); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-12 col-md-2 pt-3">
                                <label for="url"><?php echo e(__('panel.url')); ?></label>
                            </div>
                            <div class="col-sm-12 col-md-10 pt-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/useful_links/create.blade.php ENDPATH**/ ?>