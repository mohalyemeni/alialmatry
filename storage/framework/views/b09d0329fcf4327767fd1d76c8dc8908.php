<div class="wow fadeInUp" data-wow-delay=".3s">
    <div class="cousrse-card cousrse-card2">
        <div class="box-img global-img tow_height">
            ...
            <a href="<?php echo e(route('frontend.blogs.show', $blog->slug)); ?>" aria-label="<?php echo e(e($blog->title)); ?>">
                <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e(e($blog->title)); ?>" class="tow_height"
        ...
        <div class="hei">
            <h3 class="box-title">
                <a
                    href="<?php echo e(route('frontend.blogs.show', $blog->slug)); ?>"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($blog->title), 20)); ?></a>
            </h3>

            <p class="tags text-muted"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($blog->description), 50)); ?></p>
...
<?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/frontend/blogs/partials/category_partial.blade.php ENDPATH**/ ?>