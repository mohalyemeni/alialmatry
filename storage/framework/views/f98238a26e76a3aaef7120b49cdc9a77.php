<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="fatawaForm" action="<?php echo e(route('admin.fatawa.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            ...
            $form.on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('admin.fatawa.index')); ?>";
                        }, 1200);
                    },
                    error: function(err) {
                        $progress.removeClass('progress-bar-animated bg-primary').addClass(
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new_alialmatry\alialmatry\resources\views/backend/fatawa/create.blade.php ENDPATH**/ ?>