<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    <?php echo e(__('panel.add_fatawa_category')); ?>
                ...
                <ul class="breadcrumb pt-3">
                    ...
                    <li class="ms-1">
                        <a href="<?php echo e(route('admin.fatawa_categories.index')); ?>"><?php echo e(__('panel.manage_fatawa_categories')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.fatawa_categories.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <textarea name="description" id="description" rows="10" class="form-control summernote"><?php echo old('description', isset($category) ? $category->description : ''); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 pt-3">
                                <label for="featured"><?php echo e(__('panel.featured')); ?></label>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3 pt-3">
                                <label for="metadata_keywords"><?php echo e(__('panel.seo_keywords')); ?></label>
                            </div>
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input name="metadata_keywords" id="tags1" value="<?php echo e(old('metadata_keywords')); ?>"
                                    class="form-control" />
                                <?php $__errorArgs = ['metadata_keywords'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-12 col-md-10 pt-3">
                        ...
                        <a href="<?php echo e(route('admin.fatawa_categories.index')); ?>" class="btn btn-outline-danger">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\new\alshaik\root\resources\views/backend/fatawa_categories/create.blade.php ENDPATH**/ ?>