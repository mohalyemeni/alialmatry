<?php $__env->startSection('content'); ?>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.settings.site_meta.edit', 6)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_name_meta" id="site_name_meta" class="form-control"
                            value="<?php echo e($site_name_meta->value ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <textarea name="site_description_meta" id="site_description_meta" class="form-control" rows="4"><?php echo e($site_description_meta->value ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="site_link_meta" id="site_link_meta" class="form-control"
                            value="<?php echo e($site_link_meta->value ?? ''); ?>">
                    </div>
                </div>
