                            ...
                            <div class="wow fadeInUp" data-wow-delay=".3s">
                                <div class="cousrse-card cousrse-card2">
                                    ...
                                    <div class="hei">
                                        <h3 class="box-title">
                                            <a
                                                href="<?php echo e(route('frontend.blogs.show', $blog->slug)); ?>"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($blog->title), 25)); ?></a>
                                        </h3>

                                        <p class="tags text-muted">
                                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($blog->description), 80)); ?></p>
