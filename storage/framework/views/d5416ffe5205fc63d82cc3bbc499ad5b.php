                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <input name="meta_keywords" id="tags1"
                                    value="<?php echo e(old('meta_keywords', $audio->meta_keywords)); ?>" class="form-control" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-3">
                                <textarea name="meta_description" id="meta_description" rows="3" class="form-control"><?php echo e(old('meta_description', $audio->meta_description)); ?></textarea>
