    ...
    <div class="container py-5">
        ...
        <?php if($blogs->count() > 0): ?>
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="far fa-newspaper me-2 text-muted"></i><?php echo e($blog->title); ?></h5>
                ...
                <div class="mt-3"><?php echo e($blogs->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
            ...
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="fas fa-play-circle me-2 text-danger"></i><?php echo e($video->title); ?>
                ...
                <div class="mt-3"><?php echo e($videos->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
            ...
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $audios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="fas fa-music me-2 text-success"></i><?php echo e($audio->title); ?></h5>
                                <p class="mb-1 text-muted small">
                ...
                <div class="mt-3"><?php echo e($audios->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
            ...
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $fatawas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fatawa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="fas fa-scroll me-2 text-warning"></i><?php echo e($fatawa->title); ?></h5>
                                <p class="mb-1 text-muted small">
                ...
                <div class="mt-3"><?php echo e($fatawas->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
            ...
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="fas fa-book-reader me-2 text-info"></i><?php echo e($book->title); ?>
                ...
                <div class="mt-3"><?php echo e($books->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
            ...
            <section class="mb-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $durars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $durar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item d-flex justify-content-between align-items-start py-3">
                            <div>
                                <h5 class="mb-1"><i class="fas fa-gem me-2 text-secondary"></i><?php echo e($durar->title); ?></h5>
                                <p class="mb-1 text-muted small">
                ...
                <div class="mt-3"><?php echo e($durars->withQueryString()->links()); ?></div>
            </section>
        <?php endif; ?>
