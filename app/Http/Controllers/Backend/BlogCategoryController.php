...
class BlogCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.blog_categories.index', compact('page_categories'));
    }
    ...
    public function store(BlogCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.blog_categories.index')->with([
            'message' => 'تم إنشاء تصنيف المقالات بنجاح',
            'alert-type' => 'success',
        ]);
    }
    ...
    public function update(BlogCategoryRequest $request, $id)
    {
        ...
        if ($request->hasFile('img')) {
            if ($category->img && File::exists(public_path('assets/blog_categories/' . $category->img))) {
                File::delete(public_path('assets/blog_categories/' . $category->img));
            }
            $uploaded = $request->file('img');
            $fileName = 'blog_category_' . time() . '.' . $uploaded->getClientOriginalExtension();
            $path = public_path('assets/blog_categories/' . $fileName);
        ...
        return redirect()->route('admin.blog_categories.index')->with([
            'message' => 'تم تحديث تصنيف المقالات بنجاح',
            'alert-type' => 'success',
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.blog_categories.index')->with([
            'message' => 'تم حذف تصنيف المقالات بنجاح',
            'alert-type' => 'success',
        ]);
    }
