...
class AudioController extends Controller
{
    ...
    {
        if (!auth()->user()->ability(['admin', 'Supervisor'], ['manage_audios', 'show_audios'])) {
    ...
    {
        if (!auth()->user()->ability(['admin', 'Supervisor'], ['create_audios'])) {
            return redirect('admin/index');
        }
    ...
    {
        if (!auth()->user()->ability(['admin', 'Supervisor'], ['update_audios'])) {
            return redirect('admin/index');
        }
    ...
    {
        if (!auth()->user()->ability(['admin', 'Supervisor'], ['delete_audios'])) {
            return redirect('admin/index');
        }
