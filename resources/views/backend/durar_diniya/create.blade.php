...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.durar_diniya.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 pt-3">
                                <label
                                    for="img">{{ __('panel.image') }}<br><small>{{ __('panel.best_size') }}</small></label>
                            </div>
                            <div class="col-sm-12 col-md-10 pt-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 pt-3">{{ __('panel.publish_date') }}</div>
                            <div class="col-sm-12 col-md-10 pt-3">
                    ...
                    <div class="tab-pane fade" id="SEO" role="tabpanel" aria-labelledby="SEO-tab">
                        <div class="row">
                            <div class="col-sm-12 col-md-3 pt-3"><label
                                    for="meta_slug">{{ __('panel.seo_slug') }}</label></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3 pt-3"><label
                                    for="meta_description">{{ __('panel.seo_description') }}</label></div>
                            <div class="col-sm-12 col-md-9 pt-3">
