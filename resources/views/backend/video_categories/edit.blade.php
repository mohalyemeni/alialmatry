...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.video_categories.update', $category->id) }}" method="post"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 pt-3">
                                <label for="featured">{{ __('panel.featured') ?? 'مميز' }}</label>
                            </div>
                            <div class="col-sm-12 col-md-10 pt-3">
                                {{-- hidden input + star button (matches other pages) --}}
    ...
    <script>
        $(function() {
            $("#img").fileinput({
                ...
                initialPreview: [
                    @if ($category->img)
                        "{{ asset('assets/video_categories/' . $category->img) }}"
                    @endif
                ],
                    ...
                    @if ($category->img)
                        {
                            ...
                            url: "{{ route('admin.video_categories.remove_image') }}",
                            key: "{{ $category->id }}",
                            extra: {
                                _token: "{{ csrf_token() }}",
                                key: "{{ $category->id }}"
