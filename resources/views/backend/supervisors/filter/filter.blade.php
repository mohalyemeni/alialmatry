                ...
                <div class="form-group">
                    <select name="sort_by" class="form-control">
                        ...
                        <option value="first_name"
                            {{ old('sort_by', request()->input('sort_by')) == 'first_name' ? 'selected' : '' }}>First
                            Name
                        </option>
                        <option value="last_name"
                            {{ old('sort_by', request()->input('sort_by')) == 'last_name' ? 'selected' : '' }}>Last Name
                        </option>
            ...
            <div class="col-sm-1 col-md-1 col-lg-1">
                <div class="form-group">
                    <select name="limit_by" class="form-control">
                        <option value="">---</option>
                        <option
                            value="10"{{ old('limit_by', request()->input('limit_by')) == '10' ? 'selected' : '' }}>
                            10</option>
                        <option
                            value="20"{{ old('limit_by', request()->input('limit_by')) == '20' ? 'selected' : '' }}>
                            20</option>
                        <option
                            value="50"{{ old('limit_by', request()->input('limit_by')) == '50' ? 'selected' : '' }}>
                            50</option>
                        <option
