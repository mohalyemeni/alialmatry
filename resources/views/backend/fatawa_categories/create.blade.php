...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.fatawa_categories.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 pt-3">
                                <textarea name="description" id="description" rows="10" class="form-control summernote">{!! old('description', isset($category) ? $category->description : '') !!}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    </div> {{-- end content tab-pane --}}

                    {{-- SEO tab should be a sibling, not nested --}}
