    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    <i class="fa fa-edit"></i> {{ __('panel.edit_video') }}
                </h3>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.videos.update', $video->id) }}" method="POST">
                ...
                <input type="hidden" name="thumbnail" id="thumbnail" value="{{ old('thumbnail', $video->thumbnail) }}">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-7 pt-2">
                                <input type="text" id="youtube_url" class="form-control"
                                    ...
                                    value="https://www.youtube.com/watch?v={{ old('youtube_id', $video->youtube_id) }}">
                                <small class="text-muted">{{ __('panel.enter_youtube_url_to_refresh_data') }}</small>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-2">
                                <textarea name="description" id="description" rows="8" class="form-control summernote">{{ old('description', $video->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-10 pt-2">
                                <div id="video_embed_container" style="max-width:100%;">
                                    {{-- Use oEmbed html if stored, else build iframe from youtube_id --}}
                            ...
                            <div class="col-sm-12 col-md-10 pt-2">
                                <div class="input-group flatpickr" id="flatpickr-datetime">
                                    <input type="text" name="published_on"
                                        value="{{ old('published_on', optional($video->published_on)->format('Y-m-d H:i')) }}"
                    ...
                    <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-12 col-md-9 pt-2">
                                <textarea name="meta_description" id="meta_description" rows="3" class="form-control">{{ old('meta_description', $video->meta_description) }}</textarea>
    ...
    <script>
        $(function() {
            ...
            if ($('#flatpickr-datetime').length) {
                ...
                const videoDate = "{{ optional($video->published_on)->format('Y-m-d H:i') }}";
            ...
            $('#fetchBtn').on('click', function() {
                ...
                $.post("{{ route('admin.videos.fetch_data') }}", {
                    ...
                    .always(function() {
                        $btn.prop('disabled', false).text('{{ __('panel.fetch_data') }}');
                    });
            });
