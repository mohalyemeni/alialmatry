@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation"
        class="pagination-nav w-full flex items-center justify-between px-4 flex-row-reverse" dir="rtl">

        {{-- Previous --}}
        @if ($paginator->onFirstPage())
            <span
                class="th-btn style1 th-btn1 prev-btn disabled relative inline-flex items-center px-4 py-2 text-sm font-medium cursor-default leading-5 rounded-md"
        ...
        @else
            <span
                class="th-btn style1 th-btn1 next-btn disabled relative inline-flex items-center px-4 py-2 text-sm font-medium cursor-default leading-5 rounded-md"
                aria-disabled="true" style="pointer-events:none; opacity:0.6;">
                <span class="btn-text" data-back=" التالي" data-front=" التالي"> </span>
                <i class="fa-solid fa-arrow-left me-1" aria-hidden="true"></i>
            </span>
