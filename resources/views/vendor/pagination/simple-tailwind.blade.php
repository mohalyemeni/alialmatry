@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between w-full flex-row-reverse">
        {{-- Previous Page Link --}}
        <div>
            @if ($paginator->onFirstPage())
                <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium
                             ...
                             rounded-md dark:text-gray-600 dark:bg-gray-800 dark:border-gray-600">
